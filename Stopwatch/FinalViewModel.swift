...
private struct Tool {
    fileprivate static let convertToTimeInfo: (TimeInterval) -> String = { ms in
    ...
    init(input: (startAStopTrigger: Observable<Void>, resetALapTrigger: Observable<Void>)) {
        ...
        startAStopStyle = state
            .map { state in
                switch state {
                case .reseted:
                    return Style.Button(title: "Start", titleColor: Color.green, isEnabled: true, backgroungImage: #imageLiteral(resourceName: "green"))
                case .stopped:
                    return Style.Button(title: "Start", titleColor: Color.green, isEnabled: true, backgroungImage: #imageLiteral(resourceName: "green"))
                case .timing:
                    return Style.Button(title: "Stop", titleColor: Color.red, isEnabled: true, backgroungImage: #imageLiteral(resourceName: "red"))
                }
        }
